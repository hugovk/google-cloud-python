...
class TestPublisherClient(object):
    ...
    def test_update_topic(self):
        ...
        assert len(channel.requests) == 1
        expected_request = pubsub_pb2.UpdateTopicRequest(topic=topic, update_mask=update_mask)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_topic_subscriptions(self):
        ...
        expected_response = pubsub_pb2.ListTopicSubscriptionsResponse(**expected_response)
